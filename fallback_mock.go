...
//
//	mockgen -source=fallback.go -package=kafka -destination=fallback_mock.go
//
...
func (m *MockFallback) SaveMessage(ctx context.Context, msg *sarama.ProducerMessage) error {
	m.ctrl.T.Helper()
...
func (mr *MockFallbackMockRecorder) SaveMessage(ctx, msg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SaveMessage", reflect.TypeOf((*MockFallback)(nil).SaveMessage), ctx, msg)
}
